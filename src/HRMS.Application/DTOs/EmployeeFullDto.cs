...
/// <summary>
/// Full employee information - visible to HR and Admin roles
/// SECURITY: Includes all data but masks sensitive fields (bank account partially masked)
/// Used for: HR management, payroll processing, compliance reporting
/// </summary>
public class EmployeeFullDto
{
    ...
    // Salary & Bank (MASKED for HR)
    public decimal BasicSalary { get; set; }
    public string SalaryCurrency { get; set; } = "MUR";
    public string? BankName { get; set; }
    /// <summary>
    /// Bank account number - PARTIALLY MASKED (shows last 4 digits)
    /// Example: ****5678
    /// </summary>
