...
// Centralized icon management with multiple library support
// ═══════════════════════════════════════════════════════════

import { Injectable } from '@angular/core';

export type IconLibrary = 'material' | 'heroicons' | 'lucide';
...
export class IconRegistryService {
  private icons: IconRegistry = {
    ...
    heroicons: {
      // Common Heroicons (outline style)
   ...
   */
  getIcon(name: string, library: IconLibrary = 'material'): string | undefined {
    return this.icons[library]?.[name];
  }
   ...
   */
  hasIcon(name: string, library: IconLibrary = 'material'): boolean {
    return !!this.icons[library]?.[name];
  }

  /**
   * Get all available icon names for a library
   * @param library Icon library
   * @returns Array of icon names
   */
  getAvailableIcons(library: IconLibrary = 'material'): string[] {
    return Object.keys(this.icons[library] || {});
  }
}
